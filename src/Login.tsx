            ...
            <div className="space-y-6">
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button onClick={() => signInAsDemo('super_admin')} className="col-span-2 flex items-center justify-center gap-2 py-2 px-3 border border-slate-800 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-slate-800 transition-colors shadow-sm">
                    <ShieldCheck className="w-4 h-4" /> Super Admin SaaS
                  </button>
                  <button onClick={() => signInAsDemo('student')} className="flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-blue-600 transition-colors">
                    <GraduationCap className="w-4 h-4" /> Étudiant
                  </button>
                  <button onClick={() => signInAsDemo('professor')} className="flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-emerald-600 transition-colors">
                    <Briefcase className="w-4 h-4" /> Professeur
                  </button>
                  <button onClick={() => signInAsDemo('admin')} className="flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-purple-600 transition-colors">
                    <ShieldCheck className="w-4 h-4" /> Admin
                  </button>
                  <button onClick={() => signInAsDemo('cashier')} className="flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-amber-600 transition-colors">
                    <Calculator className="w-4 h-4" /> Caissier
                  </button>
                  <button onClick={() => signInAsDemo('chef')} className="col-span-2 flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-rose-600 transition-colors">
