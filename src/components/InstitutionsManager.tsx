...
export default function InstitutionsManager() {
  ...
  const closeModal = () => {
    ...
    setEditingInst(null);
    setFormData({ name: '', domain: '', plan: 'pro', status: 'active', contactEmail: '' });
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-600 uppercase tracking-wider mb-1.5">Email de contact</label>
                <input 
                  type="email" 
